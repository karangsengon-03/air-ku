...
function DonutChart({ lunas, belum }: { lunas: number; belum: number }) {
  ...
  if (total === 0) return (
    <div style={{ width: 72, height: 72, borderRadius: "50%", border: "5px solid var(--color-border)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
      <span style={{ fontSize: 13, color: "var(--color-txt3)" }}>-</span>
    </div>
  );
  ...
  return (
    <div style={{ position: "relative", width: 72, height: 72, flexShrink: 0 }}>
      ...
      <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
        ...
        <span style={{ fontSize: 13, color: "var(--color-txt3)" }}>lunas</span>
      </div>
    </div>
  );
}
    ...
    <div className="col-12 animate-fade-in-up">
      ...
      <div className="card" style={{ padding: 16 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <div className="flex-min">
            <div style={{ fontSize: 13, fontWeight: 700, color: "var(--color-txt3)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 4 }}>
      ...
      {[
        ...
        <div key={item.label} className="card" style={{ padding: "14px 16px", display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div className="flex-min">
            <div style={{ fontSize: 13, fontWeight: 700, color: "var(--color-txt3)", textTransform: "uppercase", letterSpacing: "0.04em" }}>{item.label}</div>
            <div style={{ fontSize: 16, fontWeight: 800, color: item.color, fontFamily: "JetBrains Mono, monospace" }}>{item.value}</div>
            <div style={{ fontSize: 13, color: "var(--color-txt3)", marginTop: 1 }}>{item.sub}</div>
          </div>
        </div>
      ))}
