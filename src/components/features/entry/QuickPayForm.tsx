  ...
  return (
    <div className="card" style={{ padding: 16, display: "flex", flexDirection: "column", gap: 12 }}>
      ...
      <div style={{
        ...
        borderRadius: 8, padding: "8px 12px", fontSize: 13, color: "var(--color-txt2)",
      }}>
        Ketik <strong>0</strong> untuk pelanggan baru yang belum bayar di bulan ini
      </div>

      <div>
        <label style={{ fontSize: 13, fontWeight: 700, color: "var(--color-txt3)", display: "block", marginBottom: 8 }}>
