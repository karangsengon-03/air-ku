    ...
    <div style={{
      ...
      <div style={{ marginBottom: 32, textAlign: "center" }}>
        <svg width="80" height="80" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"
          ...
          <path d="M100 28 C100 28 60 80 60 108 C60 130.9 78.1 150 100 150 C121.9 150 140 130.9 140 108 C140 80 100 28 100 28Z" fill="white" opacity="0.95"/>
          <ellipse cx="88" cy="95" rx="8" ry="14" fill="white" opacity="0.3" transform="rotate(-20 88 95)"/>
          <path d="M42 145 C55 132 70 132 83 145 C96 158 111 158 124 145 C137 132 152 132 165 145" fill="none" stroke="white" strokeWidth="9" strokeLinecap="round" opacity="0.9"/>
          <path d="M42 165 C55 152 70 152 83 165 C96 178 111 178 124 165 C137 152 152 152 165 165" fill="none" stroke="white" strokeWidth="9" strokeLinecap="round" opacity="0.65"/>
        </svg>
